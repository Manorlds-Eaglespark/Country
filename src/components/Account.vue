            ...
            <v-card flat outlined class="mx-auto my-1" max-width="98%">
                ...
                <v-container>
                    ...
                    <v-row no-gutters class="pt-2 mt-2">
                        <v-col>
                            <v-card class="pa-0" tile elevation="0">
                                <span>Rate your experience | Leave a comment</span>
                            </v-card>
                        </v-col>
                        <v-col>
                            <v-card class="pa-0" tile elevation="0">
                            ...
                            <v-row align="center" class="mx-2">
                                <v-col max-width="100%">
                                    ...
                                    <v-row no-gutters>
                                        <v-col class="mx-4">
                                            <v-card class="pa-0" tile elevation="0">
                                                <v-btn @click="isGivingFeedbackFlag = !isGivingFeedbackFlag" large color="primary" class="full-size text-capitalize" outlined :loading="save_feedback_loading"
                                                >
                                                    Cancel
                                                </v-btn>
                                            </v-card>
